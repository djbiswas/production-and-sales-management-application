...
@section('content')
    ...
    <h2 id="tr" class="text-center">Material Purchases Report</h2>
    <div class="card-header">
        <form action = "" >
            <div class="form-row">
                ...
                <div class="col">
                    {{Form::select('customer_id', $suppliers, null, ['id' => 'customer_id', 'class' => 'select2_op form-control','placeholder' => 'Select Customer', 'required'])}}
                </div>
        ...
        $(function() {
            ...
            function load_data(from_date = '', to_date = '', customer_id = '')
            {
                $('#trips_report_table').DataTable({
                    ...
                    ajax: {
                        url:'{!! route("get_material_purchases_data") !!}',
                    ...
                    columns: [
                        ...
                        { data: 'date', name: 'date' },
                        { data: 'rawmaterials.name', name: 'rawmaterials.name' },
                        ...
                        { data: 'cost', name: 'cost', className: 'sum' },
                        { data: 'price', name: 'price', className: 'sum' }
                    ],
